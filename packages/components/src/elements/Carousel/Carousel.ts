...
export class StrataCarousel extends LitElement implements CarouselProps {
  ...
  @query(".strata-carousel__container") private containerElement?: HTMLElement;
  ...
  private getCarouselClasses() {
    const classes = ["strata-carousel", "strata-carousel--flat"];

    if (this.isDragging) {
      classes.push("strata-carousel--dragging");
    }
  ...
  render() {
    ...
    return html`
      ...
      >
        <div class="strata-carousel__navigation">
